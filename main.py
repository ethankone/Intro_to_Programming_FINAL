...
class Game:
    ...
    def __init__(self):
        ...
        pg.display.set_caption("Escape the Grinch")
    ...
    def load_data(self):
        ...
        # This opens the file with write options 
        ...
        #load cloud images
        self.cloud_images = []
        self.cloud_images.append(pg.image.load(path.join(img_dir,'The_Grinch.png'.format(1))).convert())
        # load sounds
    ...
    def new(self):
        ...
        for i in range(8):
            ...
            c.rect.y += 500
        # load music
        pg.mixer.music.load(path.join(self.snd_dir, 'grinch.mp3'))
        # call the run method
        self.run()
    def run(self):
        # game loop
    ...
    def draw(self):
        ...
        # double buffering - this renders a frame "behind" the displayed frame so there is less lag.
        pg.display.flip()
    ##### WAIT FOR KEY METHOD
